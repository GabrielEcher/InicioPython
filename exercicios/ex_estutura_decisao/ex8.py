...
prod3 = float(input("Digite o preço do tercerio produto: "))

def calculo_preco(prod1, prod2, prod3):
    melhor_preco = min(prod1, prod2, prod3)
    print(f'O melhor preço dos produtos é: {melhor_preco}')
    
calculo_preco(prod1, prod2, prod3)
