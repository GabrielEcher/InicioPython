...
# O zip usa como parâmetro o menor tamanho em iterável, significa que se estiver trabalhando com 
# iteráveis de tamanhos diferentes, irá parar quando os elementos do menor iterável acabarem
