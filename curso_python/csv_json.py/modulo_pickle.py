...
#OBS: O módulo Pickle não é seguro contra dados malicioso, 
não é recomendado trabalhar com arquivos pickle vindos de outras 
...
# Fazer a leitura dos dados em arquivo pickle
